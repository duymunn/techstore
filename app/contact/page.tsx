...
export default function ContactPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.subject) errors.subject = 'Vui lòng chọn chủ đề';
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:1900xxxx" className="hover:text-blue-600">Hotline: 1900 xxxx</a>
                    </p>
                    <p className="text-gray-600">
                      <a href="tel:02473456789" className="hover:text-blue-600">CSKH: 024.7345.6789</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:info@techstore.vn" className="hover:text-blue-600">info@techstore.vn</a>
                    </p>
                    <p className="text-gray-600">
                      <a href="mailto:support@techstore.vn" className="hover:text-blue-600">support@techstore.vn</a>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Thứ 7 - Chủ nhật: 8:30 - 22:00</p>
                  </div>
                </div>
              </div>
              ...
              {submitSuccess ? (
                <div className="bg-green-50 border border-green-200 rounded-md p-4 mb-6">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-green-800">Gửi thành công!</h3>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <input 
                        type="text"
                        name="name"
                        className={`w-full border ${formErrors.name ? 'border-red-300' : 'border-gray-300'} rounded px-4 py-2 focus:outline-none focus:border-blue-500`}
                    ...
                    <div>
                      ...
                      <select 
                        name="subject"
                        className={`w-full border ${formErrors.subject ? 'border-red-300' : 'border-gray-300'} rounded px-4 py-2 focus:outline-none focus:border-blue-500`}
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea 
                        name="message"
                        className={`w-full border ${formErrors.message ? 'border-red-300' : 'border-gray-300'} rounded px-4 py-2 focus:outline-none focus:border-blue-500 h-32`}
                  ...
                  <div className="flex justify-end">
                    <button 
                      type="submit"
                      className="bg-blue-600 text-white px-6 py-3 rounded-md font-medium hover:bg-blue-700 transition-colors flex items-center disabled:opacity-70 disabled:cursor-not-allowed"
